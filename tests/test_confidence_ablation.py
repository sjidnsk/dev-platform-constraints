...
class ConfidenceAblationScriptTests(unittest.TestCase):
    def test_ablation_script_outputs_json_csv_and_goal_ranking_metrics(self) -> None:
        ...
        self.assertIn("coverage_rate", first_run)
        self.assertIn("coverage_rate_delta", first_run)
        self.assertIn("covered_valid_cell_count", first_run)
        ...
        self.assertIn("expected_new_coverage_area", first_run["top_goal_details"][0])
        self.assertIn("expected_coverage_rate_delta", first_run["top_goal_details"][0])
        ...
        self.assertIn("coverage_rate_mean", first_aggregate)
        self.assertIn("coverage_rate_delta_mean", first_aggregate)
        ...
        self.assertIn("coverage_rate", rows[0])
